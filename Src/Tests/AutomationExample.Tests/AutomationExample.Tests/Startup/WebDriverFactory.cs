...
namespace AutomationExample.Tests.Startup
{
    ...
    public class WebDriverFactory
    {
        ...
        /// </summary>
        protected WebDriverType BrowserType { get; set; }
        ...
        public IWebDriver Initialize(WebDriverType webDriverType, params string[] arguments)
        {
            ...
            switch (webDriverType)
            {
                ...
                case WebDriverType.Edge:
                    ...
                    edgeOptions.LeaveBrowserRunning = false;
                ...
                case WebDriverType.PhantomJs:
                    // https://www.selenium.dev/selenium/docs/api/javascript/page/Changes.html
                    throw new NotImplementedException($"{webDriverType} Driver Support Discontinued");
                ...
                case WebDriverType.InternetExplorer:
                    throw new NotImplementedException($"IE Driver Initialization not ready: {webDriverType}");
                default:
